Задания, в основном, связаны коллекцией новостей (data/news.txt.gz). В  файле  10,000 строк, в каждой строке содержится метка рубрики, заголовок новостной статьи и сам текст статьи, например:
